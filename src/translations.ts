export const translations = {
  "en-US": {
    discover: "Discover your next favorite movie.",
    discoverWatchlist: "Have a watchlist? Let us pick one for you.",

    searchPlaceholder: "A sci-fi movie in a galaxy far, far away...",
  ...
  "pt-BR": {
    ...
    discoverWatchlist: "Tem uma lista? Nós escolhemos um filme para você.",

    searchPlaceholder: "Um filme de uma colher que não existe...",
    ...
    mainDirectors: "Diretores Principais:",
